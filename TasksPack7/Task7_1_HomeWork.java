...
//Цикл в данном случае не нужен, поскольку повторрения кода не требуются. Заданное количество итераций  = 1 не имеет
// смысла. Опыт назначения количества итераций все же извлек. Лишние строки просто закомментировал.